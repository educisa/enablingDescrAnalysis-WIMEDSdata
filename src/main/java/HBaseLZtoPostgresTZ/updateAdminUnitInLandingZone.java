...
public class updateAdminUnitInLandingZone {


	public updateAdminUnitInLandingZone() {}
	...
	public void extractOrgUnitsFromLZ() throws InterruptedException, IOException {
		...
		//ELSE => we do not need AdministrationUnits now in Transformed Zone (it is not in TZtables in properties file)
		//do nothing
	}
